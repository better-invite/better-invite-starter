export default function TermsPage() {
	return (
		<main className="container flex flex-col gap-4 self-center p-4 text-sm md:p-6">
			...
			<p>
				This website is operated by Better Invite Starter. Throughout the site,
				the terms “we”, “us” and “our” refer to Better Invite Starter. Better
				Invite Starter offers this website, including all information, tools and
			...
			<p>
				In no case shall Better Invite Starter, our directors, officers,
			...
			<p>
				You agree to indemnify, defend and hold harmless Better Invite Starter

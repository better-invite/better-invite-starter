	...
	return (
		<main className="container flex flex-col gap-4 self-center p-4 text-sm md:p-6">
			...
			<ul>
				...
				<li>
					<p>
						<strong>Application</strong> refers to Better Invite Starter, the
				...
				<li>
					<p>
						...
						this Agreement) refers to Better Invite Starter.
					</p>
				</li>
				...
				<li>
					<p>
						<strong>Website</strong> refers to Better Invite Starter, accessible
						from{" "}
						<a
			...
			<ul>
				<li>
					...
					our Service, to contact You. These providers may include email
					delivery services such as Resend, which process data like Your email
					address and message content on Our behalf. You can review Resend's
					Privacy Policy here:{" "}
					<a
			...
			<ul>
				<li>By email: contact@better-invite.com</li>
			</ul>
		</main>
	);
}
